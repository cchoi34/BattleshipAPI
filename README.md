...
Open **BattleshipGoogleCloud.csproj**, and Press **F5**.

### Deploy to App Engine

1.  In Solution Explorer, right-click the **BattleshipGoogleCloud** project and choose **Publish BattleshipGoogleCloud to Google Cloud**.
